...
use crate::protocol::commitment::onehot::{
    inner_ajtai_onehot_wide, map_onehot_to_regular_blocks, map_onehot_to_sparse_blocks, BlockView,
    FlatRegularBlocks, FlatSparseBlocks, RegularOneHotEntry, SparseBlockEntry,
};
