...
use akita_prover::ring_switch::{build_w_coeffs, build_w_evals_compact};
use akita_prover::{
...
#[cfg(test)]
mod tests {
    use super::{compute_m_evals_x, compute_r_via_poly_division, ring_switch_build_w};
    ...
    use akita_prover::ring_switch::build_w_evals_compact;
