...
// --- Re-exports: drivers (public API) ------------------------------------

pub use drivers::{check_sumcheck_output_claim, prove_sumcheck, verify_sumcheck};

// --- Re-exports: drivers (crate-internal) --------------------------------

pub(crate) use compact_fold::CompactPairFoldLut;
#[cfg(test)]
pub(crate) use drivers::{
    advance_eq_factored_claim, prove_sumcheck_with_omitted_prefix_rounds,
    verify_sumcheck_with_prefix_rounds,
};
pub(crate) use drivers::{prove_eq_factored_sumcheck, verify_eq_factored_sumcheck};
