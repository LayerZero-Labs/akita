...
for file in "${tracked_rust_paths[@]}"; do
    ...
    if is_generated_rust_file "$file"; then
...
echo "Rust file line-cap check passed: scanned $scanned tracked Rust files; cap=$max_lines; baseline_entries=${#baseline_paths[@]}; generated_skipped=$generated_skipped."
