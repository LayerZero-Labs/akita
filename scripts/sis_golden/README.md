...
Generate the Euclidean comparison CSV or the separate diagnostic L2 table.
The generator uses the 128 bit quantum ADPS16 profile. Its key is a power of
two bound on the squared norm of the complete scalar collision vector.
