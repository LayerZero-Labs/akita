...
case "$profile_feature" in
  profile-ci-fp32)
    allowed=(FP32_D128_DENSE_SCHEDULES FP32_D128_ONEHOT_SCHEDULES)
    ;;
  profile-ci-fp64)
    allowed=(FP64_D128_DENSE_SCHEDULES FP64_D128_ONEHOT_SCHEDULES)
    ;;
  profile-ci-fp128-base)
    allowed=(FP128_DENSE_SCHEDULES FP128_ONEHOT_SCHEDULES)
    ;;
