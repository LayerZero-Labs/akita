...
def main():
    moments = json.loads(Path("moments_d128_w35.json").read_text())
    ...
    cert = {
        "description": (
            ...
            "experimental uniform d=128, weight-35 signed-unit challenge family that is contained "
        ...
        "moment_generation": {
            ...
            "a_priori_numerator_bound": "C(128,35)*1225^m for moment m",
        },
    }
    Path("cert_d128_uniform_w35_gamma14.json").write_text(json.dumps(cert, indent=1) + "\n")
