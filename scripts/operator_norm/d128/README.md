...
The certified subset is `Gamma(c) <= 13`; a fixed-point implementation can use a
strict runtime threshold of 14 to contain that true subset.

The final exact result is:

```
q1 <= 0.008120720198295826
Pr[Gamma(c) <= 13] >= 0.480273907309067161
...
The certificate uses degree 30 and 4096 rational Bernstein subintervals.
