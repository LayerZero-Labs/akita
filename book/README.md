...
- **`AGENTS.md`** is the agent hot path (commands, contract summary, pointers).
...
flags, transcript, commitment, recursion, opening-points-layout,
distributed-prover, matrix-evaluation, troubleshooting, and
verifier-only-integration chapters are written; many other pages remain stubs.
