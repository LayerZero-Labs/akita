...
`AkitaJoltInputs` blob, cycle accounting (and why D32 costs more zkVM cycles than
D64), the trusted-benchmark vs production-validation distinction, and the
nv=32 full-prove trace-length limit. Link the sub-workspace README rather than
