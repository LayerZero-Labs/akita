...
| `schedules-fp128-dense-bounded` | Generated catalog for the bounded dense preset `fp128::DenseBounded` (committed-source bound 64 inside the 128-bit field). Not in `schedules-default`; see [Bounded committed sources](../how/configuration.md#bounded-committed-sources) |
