...
| [`certified-planner-architecture`](../../../specs/certified-planner-architecture.md) | proposed | Defines the target exact guided search and phased commitment workload architecture, with owned proof and Aerie workload support files. |
