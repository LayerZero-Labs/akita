...
- [How it works](./how/how-it-works.md)
  ...
  - [The proving protocol](./how/proving/proving.md)
    ...
    - [Raw and compressed payload realizations](./how/proving/akita-fold-realizations.md)
    - [Checking ring relations over a field](./how/proving/ring-relation-checking.md)
