...
- Update `specs/archive/2026-Q2/sis-infinity-estimator-implementation-plan.md` so Slice 7 points
  to this spec and does not remain a live contradictory plan.
- Revisit `specs/archive/2026-Q2/sis-euclidean-estimator.md`; after this cutover, it should be
...
- `specs/archive/2026-Q2/sis-infinity-estimator-implementation-plan.md`
- `specs/archive/2026-Q2/sis-euclidean-estimator.md`
