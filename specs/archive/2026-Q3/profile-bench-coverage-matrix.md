...
| `onehot_fp128_recursive` | fp128 | 1-of-256 one-hot | 36 | 1 | adaptive recursive | `recursive` | The same scalar opening statement with setup contribution carried through Stage 3. |
