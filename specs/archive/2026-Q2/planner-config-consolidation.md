...
- **Setup matrix sizing** (`AkitaSetupDescriptor::max_stride`, `max_num_batched_polys`, etc.) for all presets across the `(num_vars, num_polys, num_points)` tuples exercised by tests.
