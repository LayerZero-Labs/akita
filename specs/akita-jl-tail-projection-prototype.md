...
PR #191 now uses independent Rademacher signs `{-1,+1}` with one-bit packing everywhere in the implementation.
Theoretical motivation, modular-JL lemma targets, and constant-generation notes live in [`akita-jl-binary-security.md`](akita-jl-binary-security.md).
...
### Binary modular-JL security

See [`akita-jl-binary-security.md`](akita-jl-binary-security.md) for the target modular-JL lemma, proof strategy, and constant-generation checklist.
