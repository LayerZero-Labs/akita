...
pub(crate) static FP128_DENSE_MULTI_CHUNK_SCHEDULES: &[GeneratedFoldScheduleEntry] = &[
    GeneratedFoldScheduleEntry {
        ...
        recursive_folds: &[
            GeneratedRecursiveFold { core: GeneratedFoldCore { group: GeneratedGroup { geometry: BlockGeometry::new(6019, 128, 48), inner_commit_matrix: GeneratedMatrix { ring_dimension: 512, log_basis: 3 }, outer_commit_matrix: GeneratedMatrix { ring_dimension: 64, log_basis: 5 }, outer_slice_count: 8, num_digits_fold: 2, opening_method: akita_types::OpeningMethod::SubringCoefficientPacking { challenge_subring_dimension: 64 } }, open_commit_matrix: GeneratedMatrix { ring_dimension: 64, log_basis: 5 }, witness_chunks: 8, ring_relation_mode: akita_types::RingRelationMode::QuotientLift }, setup_prefix: None, payload_mode: CommitmentPayloadMode::Compressed, response_l2_sq_cap: None },
        ],
        terminal: GeneratedTerminalFold { geometry: BlockGeometry::new(29320, 2, 14660), inner_commit_matrix: GeneratedMatrix { ring_dimension: 64, log_basis: 5 }, num_digits_inner: 1, fold_log_basis: 6, fold_digit_count: 3, inner_output_rank: 1, inner_coeff_linf_bound: 53477172, response_l2_sq_cap: None, z_linf_cap: Some(21042), z_rice_low_bits: 12, z_payload_bytes: 256 },
    },
];
...
pub(crate) static CATALOG_IDENTITY: GeneratedScheduleCatalogIdentity = GeneratedScheduleCatalogIdentity {
    ...
    key_count: 1,
    key_digest: 11816297589885759113,
};
