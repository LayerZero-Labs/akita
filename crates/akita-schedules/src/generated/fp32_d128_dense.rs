...
#[rustfmt::skip]
pub(crate) static FP32_D128_DENSE_SCHEDULES: &[GeneratedFoldScheduleEntry] = &[
    GeneratedFoldScheduleEntry {
        root: GeneratedRootFold {
            final_group: GeneratedRootFinalGroup { layout: PolynomialGroupLayout::new(26, 1), num_digits_inner: 3, num_digits_fold: 7, challenge: GeneratedRootFinalChallenge::Flat,
