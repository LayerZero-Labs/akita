...
pub(crate) static FP128_ONEHOT_MULTI_CHUNK_SCHEDULES: &[GeneratedFoldScheduleEntry] = &[
    ...
    GeneratedFoldScheduleEntry {
        root: GeneratedRootFold {
            ...
            precommitted_groups: &[
                GeneratedRootPrecommittedGroup { descriptor: CommittedGroupProfile { version: CommittedGroupProfile::VERSION, group: PolynomialGroupLayout::new(16, 1), num_live_ring_elements_per_claim: 1024, num_positions_per_block: 256, num_live_blocks: 4, log_basis_inner: 3, num_digits_inner: 1, inner_commit_matrix: InnerCommitMatrixParams::new_unchecked(SisSecurityPolicyId::Quantum128BitADPS16, SisTableDigest([168, 166, 29, 240, 246, 7, 53, 200, 238, 148, 139, 169, 167, 145, 112, 173, 36, 114, 90, 87, 43, 126, 62, 102, 223, 196, 237, 1, 57, 177, 214, 14]), SisModulusProfileId::Q128OffsetA7F7, 2, 256, 2047, 64), log_basis_outer: 3, num_digits_outer: 43, outer_commit_matrix: OuterCommitMatrixParams::new_unchecked(SisSecurityPolicyId::Quantum128BitADPS16, SisTableDigest([168, 166, 29, 240, 246, 7, 53, 200, 238, 148, 139, 169, 167, 145, 112, 173, 36, 114, 90, 87, 43, 126, 62, 102, 223, 196, 237, 1, 57, 177, 214, 14]), SisModulusProfileId::Q128OffsetA7F7, 1, 344, 7, 64) }, num_digits_fold: 1, commitment: GeneratedCommittedGroup { geometry: GeneratedBlockGeometry { live_ring_elements_per_claim: 1024, positions_per_block: 256, live_blocks: 4 }, inner_commit_matrix: GeneratedInnerCommitMatrix { ring_dimension: 64, log_basis: 3 }, outer_commit_matrix: GeneratedOuterCommitMatrix { ring_dimension: 64, log_basis: 3, slice_count: 1 } } },
                GeneratedRootPrecommittedGroup { descriptor: CommittedGroupProfile { version: CommittedGroupProfile::VERSION, group: PolynomialGroupLayout::new(16, 1), num_live_ring_elements_per_claim: 1024, num_positions_per_block: 256, num_live_blocks: 4, log_basis_inner: 3, num_digits_inner: 1, inner_commit_matrix: InnerCommitMatrixParams::new_unchecked(SisSecurityPolicyId::Quantum128BitADPS16, SisTableDigest([168, 166, 29, 240, 246, 7, 53, 200, 238, 148, 139, 169, 167, 145, 112, 173, 36, 114, 90, 87, 43, 126, 62, 102, 223, 196, 237, 1, 57, 177, 214, 14]), SisModulusProfileId::Q128OffsetA7F7, 2, 256, 2047, 64), log_basis_outer: 3, num_digits_outer: 43, outer_commit_matrix: OuterCommitMatrixParams::new_unchecked(SisSecurityPolicyId::Quantum128BitADPS16, SisTableDigest([168, 166, 29, 240, 246, 7, 53, 200, 238, 148, 139, 169, 167, 145, 112, 173, 36, 114, 90, 87, 43, 126, 62, 102, 223, 196, 237, 1, 57, 177, 214, 14]), SisModulusProfileId::Q128OffsetA7F7, 1, 344, 7, 64) }, num_digits_fold: 1, commitment: GeneratedCommittedGroup { geometry: GeneratedBlockGeometry { live_ring_elements_per_claim: 1024, positions_per_block: 256, live_blocks: 4 }, inner_commit_matrix: GeneratedInnerCommitMatrix { ring_dimension: 64, log_basis: 3 }, outer_commit_matrix: GeneratedOuterCommitMatrix { ring_dimension: 64, log_basis: 3, slice_count: 1 } } },
            ],
            open_commit_matrix: GeneratedOpenCommitMatrix { ring_dimension: 64, log_basis: 3, slice_count: 1 },
            witness_partition: GeneratedWitnessPartition::Distributed { num_chunks: 8 },
...
pub(crate) static CATALOG_IDENTITY: GeneratedScheduleCatalogIdentity = GeneratedScheduleCatalogIdentity {
    ...
    key_count: 2,
    key_digest: 14495305455000982018,
};
