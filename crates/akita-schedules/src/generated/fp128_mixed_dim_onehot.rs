...
#[rustfmt::skip]
pub(crate) static CATALOG_RING_DIMENSION_CANDIDATES: &[CommitmentRingDims] = &[CommitmentRingDims { inner: 64, outer: 64, opening: 64 }, CommitmentRingDims { inner: 128, outer: 64, opening: 64 }, CommitmentRingDims { inner: 128, outer: 128, opening: 128 }, CommitmentRingDims { inner: 256, outer: 128, opening: 128 }];
#[rustfmt::skip]
...
pub(crate) static CATALOG_IDENTITY: GeneratedScheduleCatalogIdentity = GeneratedScheduleCatalogIdentity {
    ...
    key_count: 1,
    key_digest: 12577936677194848894,
};
