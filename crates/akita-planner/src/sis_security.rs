...
/// lattice estimator.
pub const MAX_RANK: u32 = 7;
const _: () = assert!(MAX_RANK == 7, "SIS width table only covers ranks 1..=7");
...
fn sis_max_widths(d: u32, collision_inf: u32) -> Option<[u64; MAX_RANK as usize]> {
    match (d, collision_inf) {
        ...
        (32, 1023) => Some([10, 27, 1_581, 74_347, 2_232_996, 47_146_180, 778_938_977]),
        (32, 2047) => Some([9, 23, 395, 18_568, 557_703, 11_775_031, 194_544_527]),
        (32, 4095) => Some([9, 20, 98, 4_639, 139_357, 2_942_320, 48_612_380]),
        (32, 8191) => Some([8, 18, 36, 1_159, 34_830, 735_400, 12_150_127]),
        (32, 16383) => Some([7, 16, 30, 289, 8_706, 183_827, 3_037_161]),
        (32, 32767) => Some([7, 15, 26, 72, 2_176, 45_954, 759_243]),
        (32, 65535) => Some([7, 14, 24, 39, 544, 11_488, 189_805]),
        (32, 131071) => Some([6, 13, 22, 34, 136, 2_872, 47_450]),
        (32, 262143) => Some([6, 12, 20, 30, 47, 717, 11_862]),
...
mod tests {
    ...
    #[test]
    fn exceeds_max_rank() {
        assert_eq!(min_rank_for_secure_width(32, 262143, 20_000), None);
    }
