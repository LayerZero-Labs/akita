...
struct UnprunedCtx<'a> {
    ...
    potential_a_dimensions: &'a [usize],
    potential_b_dimensions: &'a [usize],
    potential_d_dimensions: &'a [usize],
...
pub(super) fn find_schedule(
    ...
    let crate::RingDimensionScheduleMode::AdaptiveDimension {
        ...
        return Err(AkitaError::InvalidSetup(
            "unpruned traversal requires AdaptiveDimension policy".to_string(),
        ));
    };
            ...
            for block_bits in min_block_bits..=max_block_bits {
                ...
                for suffix in enumerate_suffixes(
                    ...
                    UnprunedState {
                        ...
                        input_witness_len: output_witness_len,
                        current_log_basis: log_basis,
                        dimension_ceiling: if num_search_levels <= 1 {
                            CommitmentRingDims::uniform(uniform_suffix_dimension)
                        } else {
