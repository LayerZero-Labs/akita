...
pub use protocol::{
    batched_prove, commit_next_w, prepare_batched_prove_inputs, prove_folded_batched,
    prove_root_direct, prove_root_fold, prove_suffix, prove_terminal_root_fold_with_params,
