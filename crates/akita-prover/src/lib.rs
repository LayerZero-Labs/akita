...
pub use compute::{
    prewarm_ntt_requirements, CommitCluster, ComputeBackendSetup, CpuBackend,
    ...
    OperationCtx, PreparedCrtNttProfile, PreparedNttCacheMetric, ProveFlowBackendFor,
    ProveStackFor, ProverComputeStack, RecursiveProveBackend, ReleaseRootNttAfterFold,
    RingSwitchCluster, RingSwitchProveBackend, RingSwitchRelationRows, RootOpeningSource,
    RootPolyMeta, RootPolyShape, RootProveBackend, RootProvePoly, RootTensorSource,
    RoutedNttRequirement, RuntimeCoefficientPackingBackendFor, RuntimeOpeningProveBackendFor,
...
pub use protocol::{
    batched_prove, build_relation_weight_events, commit_terminal_w, commit_w, RelationSetupSource,
