...
pub use protocol::{
    batched_prove, batched_prove_structured_legacy, build_relation_weight_events,
    commit_terminal_w, commit_w, ProveLevelOutput, RecursiveSuffixOutcome, RelationSetupSource,
