...
impl<F: FieldCore, I: OneHotIndex> OneHotPoly<F, I> {
        ...
        F: CanonicalField,
    {
        ...
        let block_views: Vec<&[E]> = (0..blocks.live_block_count())
        ...
        F: CanonicalField,
    {
        ...
        let cached_blocks = polys
            .iter()
            .map(|poly| poly.blocks_for(D, positions_per_block).ok())
        ...
        for cached in &cached_blocks {
            ...
            for i in 0..blocks.live_block_count() {
        ...
        F: CanonicalField,
    {
        ...
        let first_blocks = first
            ...
            .expect("OneHotPoly::decompose_fold_batched_tensor_onehot: invalid positions_per_block for first polynomial");
        ...
        let cached_blocks = polys
            .iter()
            .map(|poly| poly.blocks_for(D, positions_per_block))
