    ...
    fn decompose_fold_integer_batched(
        ...
        match **first {
            Self::Dense(_) => {
                ...
                <DensePoly<F, D> as AkitaPolyOps<F, D>>::decompose_fold_integer_batched(
                    &dense_polys,
                    challenges,
                    block_len,
                    num_digits,
            ...
            Self::OneHot(_) => {
                ...
                <OneHotPoly<F, D, I> as AkitaPolyOps<F, D>>::decompose_fold_integer_batched(
                    &onehot_polys,
                    challenges,
                    block_len,
                    num_digits,
    ...
    fn decompose_fold_stage1_batched(
        ...
        match **first {
            Self::Dense(_) => {
                ...
                <DensePoly<F, D> as AkitaPolyOps<F, D>>::decompose_fold_stage1_batched(
                    &dense_polys,
                    challenges,
                    block_len,
                    num_digits,
            ...
            Self::OneHot(_) => {
                ...
                <OneHotPoly<F, D, I> as AkitaPolyOps<F, D>>::decompose_fold_stage1_batched(
                    &onehot_polys,
                    challenges,
                    block_len,
                    num_digits,
