...
fn negative_binary_digits<F: Field + CanonicalEncoding, const D: usize>(
    coefficients: &[F],
    input_width: usize,
...
mod tests {
    ...
    fn assert_negative_binary_digits<F: Field + CanonicalEncoding, const D: usize>() {
    ...
    fn deterministic_matrix_row<F: Field + CanonicalEncoding, const D: usize>(
        column_count: usize,
        salt: usize,
    ...
    fn schoolbook_rank_one_digit_mat_vec<F: Field + CanonicalEncoding, const D: usize>(
    ...
    fn compress_map_stage_against_schoolbook<F: Field + CanonicalEncoding, const D: usize>(
        coefficients: &[F],
    ...
    fn run_ladder_against_schoolbook<F: Field + CanonicalEncoding>(
        profile: SisModulusProfileId,
        source_bytes: usize,
    ) {
