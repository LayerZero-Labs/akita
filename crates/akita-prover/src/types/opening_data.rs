...
use akita_types::{AkitaCommitmentHint, FlatRingVec, OpeningClaims};
...
pub struct ProverOpeningData<'a, PointF: Clone, P, CommitF: FieldCore, const D: usize> {
    opening_claims: OpeningClaims<'a, PointF, FlatRingVec<CommitF>>,
    ...
    ProverOpeningData<'a, PointF, P, CommitF, D>
{
    ...
    pub fn opening_claims(&self) -> &OpeningClaims<'a, PointF, FlatRingVec<CommitF>> {
        &self.opening_claims
    }
