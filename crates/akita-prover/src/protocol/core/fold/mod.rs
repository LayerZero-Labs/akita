...
pub(in crate::protocol::core) use extension_claim::{
    prepare_extension_claim_fold, prepare_extension_claim_fold_native, ExtensionOpeningSource,
};
pub(in crate::protocol::core) use single_field::{
    prepare_single_field_fold, prepare_single_field_fold_native,
};
...
mod stages;
use stages::{
    prove_stage1, prove_stage1_native, prove_stage2, prove_stage2_native, prove_stage3,
    prove_stage3_native,
};
