        ...
        + RingSwitchProveBackend<F, D>,
{
    ...
    for &group_index in &order {
        ...
        let log_basis_commit = group.params.log_basis_commit();
        let log_basis_open = group.params.log_basis_open();
        let num_digits_commit = group.params.num_digits_commit();
        ...
        validate_i8_setup_log_basis(log_basis_commit, "for multi-group relation quotient")?;
