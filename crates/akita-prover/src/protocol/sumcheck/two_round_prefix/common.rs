...
#[inline(always)]
pub(crate) fn stage1_b4_s_digit_frorelation_matrix_col_evals_compact_s(s: i16) -> usize {
    match s {
        0 => 0,
        2 => 1,
...
#[inline(always)]
pub(crate) fn stage1_b8_s_digit_frorelation_matrix_col_evals_compact_s(s: i16) -> usize {
    match s {
        0 => 0,
        2 => 1,
        6 => 2,
