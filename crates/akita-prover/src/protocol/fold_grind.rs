...
use akita_challenges::{Challenges, FoldDraw, NativePreviewFoldDraw, NativeProverFoldDraw};
    ...
    let witness = dispatch_for_field!(
        ...
        |D| {
            ...
            witnesses
                .into_iter()
                .next()
                .ok_or_else(|| AkitaError::InvalidInput("terminal fold returned no witness".into()))
        }
    )?;
