...
use akita_types::{
    ...
    decomposition_digits_per_scalar, derive_tensor_extension_opening_claim_from_partials,
    embed_ring_subfield_scalar, embed_ring_subfield_vector, ensure_trace_stage2_supported,
    evaluate_commitment_compression, folded_root_supports_opening_shape,
    linearize_compression_chain, linearize_raw_ring_rows_to_first_digits, prepare_opening_point,
    ...
    CleartextWitnessProof, CommitmentCompressionPlan, CompressionEvaluation,
    CompressionLinearization, ExecutionSchedule, ExtensionOpeningReductionProof, FlatRingVec,
    LevelParams, MRowLayout, OpeningBatchShape, PreparedOpeningPoint, RingMultiplierOpeningPoint,
    RingRelationSegmentLayout, Schedule, SetupContributionMode, SetupPrefixProverRegistry,
...
pub(in crate::protocol::core) use fold::{
    prepare_fold_inner, prove_fold, reject_active_b_side_compression, scheduled_m_row_layout,
    PreparedFold,
};
