...
use akita_types::{
    ...
    ExecutionSchedule, ExtensionOpeningReductionProof, FlatRingVec, FoldAOnesTable, LevelParams,
    MRowLayout, OpeningClaims, OpeningClaimsLayout, PreparedOpeningPoint, RingCommitment,
