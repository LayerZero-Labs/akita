...
where
    F: FieldCore + Valid + FpExt4MulBackend + 'static,
    PF: PackedField<Scalar = F>,
{
...
where
    F: FieldCore + Valid + HasPacking + FpExt4MulBackend + 'static,
{
...
where
    F: FieldCore + Valid + FpExt8MulBackend + 'static,
    PF: PackedField<Scalar = F>,
{
...
where
    F: FieldCore + Valid + HasPacking + FpExt8MulBackend + 'static,
{
