...
use akita_types::{
    ...
    AkitaBatchedProof, AkitaBatchedRootProof, AkitaLevelProof, AkitaProofStep, AkitaScheduleInputs,
    ...
    T: Transcript<F>,
{
    ...
    let y_rings_flat = proof.fold_y_rings().ok_or(AkitaError::InvalidProof)?;
