    ...
    E: ExtField<F> + MulBaseUnreduced<F>,
{
    ...
    let plan = relation_weight_evaluator.setup_contribution_plan::<F>(
        full_vec_randomness,
...
fn validate_role_alpha_pows<E: FieldCore>(
    ...
    let d_a = relation_weight_evaluator.role_dims.d_a();
    ...
    let d_d = relation_weight_evaluator.role_dims.d_d();
    ...
    let d_b = relation_weight_evaluator.role_dims.d_b();
