...
use akita_field::{
    AkitaError, CanonicalField, ExtField, FieldCore, MulBaseUnreduced, Prime128OffsetA7F7,
};
use akita_types::{
...
// cross-check the optimized `setup_contribution_plan` path above. It builds the
// plan and evaluates it directly, validating the per-role alpha-power lengths
// first.
#[allow(clippy::too_many_arguments)]
fn evaluate_setup_contribution_direct<F, E, const D: usize>(
