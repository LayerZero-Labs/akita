...
use super::oracle::evaluate_setup_contribution_direct;
...
impl SetupContributionShape {
    ...
    pub(super) fn recursive_multi_group() -> Self {
        Self {
            num_live_blocks: 8,
            num_claims: 3,
            depth_open: 26,
    ...
    pub(super) fn e_t_offset_carry() -> Self {
        let mut shape = Self::root_single_point();
...
impl SetupContributionFixture {
    ...
    pub(super) fn compute_contribution(&self) -> TestField {
    ...
    pub(super) fn materialized_contribution(&self) -> TestField {
        let plan = self
            .relation_matrix_evaluator
    ...
    pub(super) fn assert_direct_matches_materialized(&self) {
    ...
    pub(super) fn assert_setup_index_weight_mle_matches_materialized(&self) {
        let plan = self
            .relation_matrix_evaluator
            .setup_contribution_plan::<TestField>(
                &self.full_vec_randomness,
