...
pub use proof_size::{
    ...
    planned_next_w_len, planned_next_w_len_with_claims, planned_setup_claim_reduction_rounds,
    planned_setup_field_len, planned_setup_padded_dims, planned_w_ring_element_count,
