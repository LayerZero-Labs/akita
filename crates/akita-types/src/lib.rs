...
pub use proof::{
    ...
    FlatDigitBlocks, LevelProofShape, OpeningBatchLimits, OpeningBatchShape, OpeningGroupShape,
    OpeningPoints, PointVariableSelection, PreparedOpeningPoint, ProverCommitmentRows,
    PublicMatrixSeed, RelationOnlyStage2Inputs, RingCommitment, RingMultiplierOpeningPoint,
    RingRelationInstance, RingRelationOpeningCounts, RingRelationSegmentLayout,
    RingRelationSegmentLengths, RingSliceSerializer, RingVec, RingView, SegmentTypedWitness,
