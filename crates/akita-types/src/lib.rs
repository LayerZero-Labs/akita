...
pub use layout::{
    ...
    CompressionCatalogProjection, CompressionChainChoice, CompressionChainSpec, CompressionChoice,
    CompressionDimensionCost, CompressionFChoice, CompressionMapChoice, CompressionMapSpec,
    CompressionMapStructuralCost, CompressionRelationStructuralCost, CompressionSourceId,
    FlatMatrix, FrozenCompressionChainChoice, LevelParams, LevelParamsLike,
