...
pub use layout::{
    ...
    terminal_response_bytes, terminal_response_upper_bound_bytes,
    ...
    CommitmentRingDims, CommittedGroupParams, CompressionRelationAddressGeometry, DigitRangePlan,
    FlatBooleanDomain, FlatMatrix, GadgetDigits, GroupOpenPhaseParams, GroupOpeningPlan,
    InnerRoleParams, OpenRoleParams, OpeningClaimsLayout, OpeningMethod, OuterRoleParams,
    PolynomialGroupLayout, PrecommittedGroupAdmissionPolicy, RelationAddressGeometry,
    ...
    SETUP_SUMCHECK_DEGREE, SUPPORTED_CHALLENGE_RING_DIMS, SUPPORTED_COMMITMENT_RING_DIMS,
};
pub use native_eor::{
...
pub use proof::{
    ...
    RingRelationGroupOpeningView, RingRelationInstance, RingVec, RingView, SetupMatrixCapacity,
    SetupPrefixPublicCommitment, SetupPrefixSlotId, SetupPrefixVerifierRegistry,
    SetupPrefixVerifierSlot, SubfieldMultiplierOpeningPoint, TerminalResponse,
