...
pub use layout::{
    ...
    CommitmentRingDims, CommittedGroupParams, CompressionRelationAddressGeometry, FlatMatrix,
    GadgetDigits, GroupOpenPhaseParams, GroupOpeningPlan, InnerRoleParams, OpenRoleParams,
    OpeningMethod, OuterRoleParams, PrecommittedGroupAdmissionPolicy, RelationAddressGeometry,
    RelationGroupRows, RelationRhsLayout, RelationRowFamily, RelationRowGeometry,
    RelationWitnessGeometry, RingMatrixView, RingOpeningPoint, RingRole, RoleParams,
...
pub use proof::{
    ...
    emit_witness_e_planes, emit_witness_t_planes, generate_relation_rhs, padded_setup_prefix_len,
    ...
    terminal_response_upper_bound_bytes, validate_coefficient_packing_batch_groups,
    ...
    CoefficientPackingStage2Terms, Commitment, CommitmentSetupMatrixShape, CommittedGroup,
    CompressionRelationWeights, DigitBlockIter, DigitBlocks, ExtensionOpeningReductionShape,
    GroupBatchStatement, GroupFoldChallenges, NegativeBinarySupport, OpeningClaims,
    OpeningClaimsLayout, OpeningFamily, OpeningPoints, PhysicalResponsePlan, PolynomialGroupClaims,
    PolynomialGroupLayout, PreparedOpeningPoint, PreparedRingMultiplier, PublicMatrixDerivation,
    ReducedCompressionRelationWeights, RelationRangeImageGroupPlan, RelationRangeImagePlan,
    RelationWeightContribution, RelationWeightEvent, RingMultiplierOpeningPoint,
    RingRelationGroupOpening, RingRelationGroupOpeningView, RingRelationInstance, RingVec,
    RingView, SetupMatrixCapacity, SetupPrefixPublicCommitment, SetupPrefixSlotId,
    SetupPrefixVerifierRegistry, SetupPrefixVerifierSlot, SubfieldMultiplierOpeningPoint,
    TailSegmentGroupLayout, TailSegmentLayout, TerminalResponse, TerminalResponseShape,
    ValidatedCoefficientPackingGroup, WitnessCoefficientSink,
