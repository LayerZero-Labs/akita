...
pub use proof::{
    ...
    tail_golomb_rice_z_params, tail_segment_layout, terminal_e_hat_bytes_from_blocks,
    ...
    validate_public_matrix_matches_seed, verifier_claims_to_opening_batch, AkitaBatchedFoldRoot,
