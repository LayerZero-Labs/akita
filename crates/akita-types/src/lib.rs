...
pub use instance_descriptor::{
    ...
    SetupSection, TerminalProofMode,
};
pub use layout::{
    ...
    terminal_level_proof_bytes_for_mode, AjtaiKeyParams, BasisMode, BlockOrder, FlatMatrix,
    LevelParams, MRowLayout, RingMatrixView, RingOpeningPoint, SisModulusFamily,
};
#[cfg(feature = "zk")]
...
pub use proof::{
    ...
    SetupSumcheckProof, TerminalLevelProof, TerminalLevelProofShape, TerminalRelationProof,
    TerminalRelationProofShape, TerminalWitnessSegmentLayout, TerminalWitnessTranscriptParts,
    VerifierClaims, MAX_SETUP_MATRIX_FIELD_ELEMENTS, SETUP_SUMCHECK_DEGREE,
};
#[cfg(feature = "zk")]
...
pub use schedule::{
    ...
    AkitaScheduleLookupKey, DirectStep, FoldStep, Schedule, Step, TerminalWitnessQuotient,
};
pub use setup_contribution::{SetupContributionPlan, SetupContributionPlanInputs};
pub use sis::decomp_depths;
