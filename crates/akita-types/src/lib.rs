...
pub use proof::{
    ...
    RingMultiplierOpeningPoint, RingSliceSerializer, SetupMatrixEnvelope, SetupRoleDimensions,
    TerminalLevelProof, TerminalLevelProofShape, VerifierClaims, ZkBlindingSeed,
};
pub use schedule::{
