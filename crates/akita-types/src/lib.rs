...
pub use proof::{
    ...
    AkitaExpandedSetup, AkitaLevelProof, AkitaOpeningClaim, AkitaOpeningPoint, AkitaProofStep,
    ...
    FlatRingVec, IncidenceClaim, IncidenceGroup, LevelProofShape, MultiPointBatchShape,
    OpeningPoints, PackedDigits, PreparedRootOpeningPoint, PublicMatrixSeed, RingCommitment,
