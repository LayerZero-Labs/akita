...
pub use proof::{
    ...
    append_prepared_root_opening_point, carried_opening_incidence_summary, checked_total_claims,
    ...
    CarriedOpeningClaim, CarriedOpeningKind, CarriedOpeningProof, CarriedOpeningShape,
    CarriedOpeningSource, CarriedOpeningSourceProof, CarriedOpeningSourceShape, ClaimIncidence,
