...
pub use layout::{
    ...
    CompressionCatalogProjection, CompressionChainSpec, CompressionDimensionCost,
    CompressionMapSpec, CompressionMapStructuralCost, CompressionRelationStructuralCost,
    CompressionSourceId, FlatMatrix, LevelParams, LevelParamsLike, PrecommittedLevelParams,
