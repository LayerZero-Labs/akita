...
pub use proof::{
    ...
    grouped_root_rejection, i8_digits_to_bytes, padded_scalar_batch_num_vars,
    ...
    terminal_witness_transcript_parts, validate_public_matrix_matches_seed,
    ...
    CleartextWitnessProof, CleartextWitnessShape, CommitmentVerifier, DummyProof,
    ExtensionOpeningReductionProof, ExtensionOpeningReductionShape, FlatDigitBlockIter,
    FlatDigitBlocks, FlatRingVec, GroupedRootRejection, LevelProofShape, OpeningClaims,
    ...
    RingRelationOpeningCounts, RingRelationSegmentLengths, RingSliceSerializer,
