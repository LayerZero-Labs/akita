...
pub use proof::{
    ...
    prepare_coefficient_packing_group_semantics, prepare_opening_point, raw_field_segment_bytes,
    ...
    CoefficientPackingStage2Terms, Commitment, CommitmentVerifier, CommittedGroup,
