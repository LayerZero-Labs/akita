...
pub use proof::{
    ...
    FlatDigitBlockIter, FlatDigitBlocks, FlatRingVec, LevelProofShape, OpeningPoints,
    OpeningStatement, PackedDigits, PointToPolynomialMap, PreparedRootOpeningPoint,
    PublicMatrixSeed, RingCommitment, RingSliceSerializer,
};
pub use schedule::{
