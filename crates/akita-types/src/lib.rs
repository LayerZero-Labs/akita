...
pub use proof::{
    ...
    append_claim_values_to_transcript, build_segment_typed_witness, checked_total_claims,
    ...
    FlatDigitBlocks, FlatRingVec, LevelProofShape, OpeningClaims, OpeningClaimsLayout,
