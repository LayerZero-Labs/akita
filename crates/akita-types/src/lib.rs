...
pub use layout::{
    ...
    CompressionCatalogProjection, CompressionChainChoice, CompressionChainSpec,
    CompressionDimensionCost, CompressionMapChoice, CompressionMapSpec,
    CompressionMapStructuralCost, CompressionRelationStructuralCost, CompressionSourceId,
    CompressionTerminalRelationShape, FlatMatrix, FrozenCompressionChainChoice,
    LevelCompressionPlan, LevelParams, LevelParamsLike, PrecommittedLevelParams,
    RelationFamilyProvider, RelationGroupId, RelationLayout, RelationMatrixRowLayout,
    RelationRowId, RelationRowPlan, RingMatrixView, RingOpeningPoint, RingRole,
    SharedSetupMatrixView, ValidatedCompressionCatalog, MAX_FOLD_LEVELS,
...
pub use proof::{
    ...
    expand_segment_typed_to_i8_digits, folded_root_supports_opening_shape, i8_digits_to_bytes,
    padded_scalar_batch_num_vars, padded_setup_prefix_len, prepare_opening_point,
    relation_claim_from_layout_extension, ring_subfield_packed_extension_opening_point,
