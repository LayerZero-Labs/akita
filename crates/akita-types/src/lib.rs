...
pub use layout::{
    ...
    validate_schedule_ring_dims, witness_commitment_domain_len, AkitaStage1StageShape, BasisMode,
    BlockGeometry, CommitmentRingDims, CommittedGroupParams, CompressionRelationAddressGeometry,
    ...
    RoleParams, EXTENSION_OPENING_REDUCTION_DEGREE, MAX_FOLD_LEVELS,
    MIN_A_ROLE_FOLD_CHALLENGE_RING_D, SETUP_SUMCHECK_DEGREE, SUPPORTED_CHALLENGE_RING_DIMS,
...
pub use proof::{
    ...
    SetupPrefixVerifierSlot, SubfieldMultiplierOpeningPoint, TailSegmentGroupLayout,
    TailSegmentLayout, TerminalResponse, TerminalResponseShape, ValidatedCoefficientPackingGroup,
    WitnessCoefficientSink, MAX_GENERIC_SETUP_DECODE_FIELD_ELEMENTS,
    MAX_UNTRUSTED_COMMITMENT_COEFFICIENTS, SETUP_PREFIX_CONTENT_TAG,
};
pub use proof::{
