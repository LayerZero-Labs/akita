...
pub use proof::{
    ...
    append_claim_values_to_transcript, assemble_relation_rhs, build_terminal_response_from_groups,
    compute_relation_matrix_col_evals, compute_relation_weight_evals,
    decode_terminal_z_golomb_payload, derive_public_matrix_flat, emit_witness_e_planes,
