...
pub use proof::{
    ...
    AkitaCommitmentHint, ErasedCommitmentHint, AkitaExpandedSetup, AkitaIntermediateStage2Proof, AkitaLevelProof,
    ...
    SetupPrefixPublicCommitment, SetupPrefixRegistry, SetupPrefixSlot,
