...
pub use proof::{
    ...
    terminal_w_hat_bytes_from_blocks, terminal_witness_remainder_bytes,
    terminal_witness_segment_layout, terminal_witness_segment_layout_from_counts,
    terminal_witness_transcript_parts, terminal_witness_w_hat_bytes, validate_batched_inputs,
