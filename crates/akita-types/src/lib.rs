...
pub use layout::{
    ...
    RelationMatrixRowLayout, RelationRowLayout, RingMatrixView, RingOpeningPoint, RingRole,
...
pub use proof::{
    ...
    evaluation_trace_row_weight, expand_segment_typed_to_i8_digits,
    ...
    relation_rhs_row_count, relation_weight_claim_from_layout_extension,
