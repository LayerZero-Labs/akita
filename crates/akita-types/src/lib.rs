...
pub use proof::{
    ...
    sample_akita_setup_seed, setup_matrix_capacity_for_schedule,
    ...
    suffix_opening_layout, tail_segment_multiplicities_from_layout,
    ...
    validate_public_matrix_matches_seed, validate_terminal_response_z_payload,
