...
pub use proof::{
    ...
    relation_claim_from_rows_extension, relation_claim_from_rows_extension_tiered,
    ring_inner_product_with_extension_weights, ring_subfield_packed_extension_opening_point,
    root_tensor_projection_enabled, sample_public_row_coefficients, validate_batched_inputs,
    ...
    CommittedOpenings, DirectWitnessProof, DirectWitnessShape, DummyProof,
    ...
    RingCommitment, RingMultiplierOpeningPoint, RingSliceSerializer, TerminalLevelProof,
    TerminalLevelProofShape, VerifierClaims,
};
pub use schedule::{
