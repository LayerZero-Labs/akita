...
pub use proof::{
    ...
    AkitaCommitmentHint, AkitaExpandedSetup, AkitaLevelProof, AkitaProofStepShape, AkitaSetupSeed,
    ...
    TerminalLevelProof, TerminalLevelProofShape, TerminalQuotientMode,
    TerminalWitnessTranscriptParts, MAX_SETUP_MATRIX_FIELD_ELEMENTS,
