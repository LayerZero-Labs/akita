...
pub use layout::{
    ...
    GroupOpeningPlan, InnerRoleParams, OpenRoleParams, OpeningMethod, OuterRoleParams,
...
pub use proof::{
    ...
    NegativeBinarySupport, OpeningClaims, OpeningClaimsLayout, OpeningFamily, OpeningPoints,
    PhysicalResponsePlan, PolynomialGroupClaims, PolynomialGroupLayout, PreparedOpeningPoint,
    ...
    TerminalResponseShape, ValidatedCoefficientPackingGroup, WitnessCoefficientSink,
