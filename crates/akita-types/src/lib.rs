...
pub use proof::{
    align_recursive_opening_point, append_batched_commitments_to_transcript,
    ...
    suffix_witness_hypercube_num_vars, tail_golomb_rice_z_params, tail_segment_layout,
...
pub use schedule::{
    ...
    terminal_tail_grind_level_params, w_ring_element_count, w_ring_element_count_with_counts,
...
pub use setup_geometry::{
    active_setup_field_len, compute_setup_layout, ensure_setup_envelope,
    setup_active_ring_elems_at, setup_active_ring_elems_for_fold, setup_required_for_shape,
    stage3_offload_natural_field_len, SetupLayoutFootprint, SetupRelationShape,
};
