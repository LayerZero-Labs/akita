...
pub use layout::{
    apply_dynamic_tier, basis_weights, decomp_depths, direct_witness_bytes,
    dynamic_tier_num_digits_outer, dynamic_tier_split_factor,
...
pub use proof::{
    ...
    relation_claim_from_rows_extension_tiered, ring_inner_product_with_extension_weights,
    ring_subfield_packed_extension_opening_point, root_tensor_projection_enabled,
    sample_public_matrix_seed, sample_public_row_coefficients, terminal_w_hat_bytes_from_blocks,
