...
pub use proof::{
    ...
    append_claim_incidence_shape_to_transcript, append_prepared_root_opening_point,
    ...
    validate_batched_inputs, AkitaBatchedFoldRoot, AkitaBatchedProof, AkitaBatchedProofShape,
    AkitaBatchedRootProof, AkitaCommitment, AkitaCommitmentHint, AkitaExpandedSetup,
    AkitaLevelProof, AkitaOpeningClaim, AkitaOpeningPoint, AkitaProofStep, AkitaProofStepShape,
    ...
    IncidenceClaim, IncidenceGroup, LevelProofShape, MultiPointBatchShape, OpeningPoints,
