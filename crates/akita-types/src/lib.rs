...
pub use instance_descriptor::{
    digest_effective_schedule, digest_level_params, digest_serializable, public_matrix_id_digest,
...
pub use proof::{
    ...
    sample_public_matrix_id, sample_public_row_coefficients, select_setup_prefix_slot,
    ...
    FoldLevelProof, GroupBatchStatement, LevelProofShape, NegativeBinarySupport,
    ...
    UncheckedL2NormDiagnostic, MAX_GENERIC_SETUP_DECODE_FIELD_ELEMENTS,
