...
pub use ntt_cache::{
    ...
    dense_i8_commit_prefers_exact_i16, dense_i8_commit_prefers_exact_i16_for_profile,
    ntt_cache_requires_i16_tail, ntt_cache_requires_i16_tail_for_profile,
    prepare_compression_ntt_cache, prepare_ntt_cache, select_compression_crt_ntt_params,
    select_crt_ntt_params, NttCacheKey, NttCacheMode, NttPrefixRequirement, NttTransformDomain,
    PreparedNttCache, PreparedNttTailPairView, ProtocolCrtNttParams,
};
pub use proof::{
