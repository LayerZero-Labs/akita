...
pub use proof::{
    ...
    append_claim_values_to_transcript, assemble_relation_rhs, build_relation_weight_events,
    ...
    RelationRangeImagePlan, RelationRhsLayout, RelationSetupSource, RelationWeightContribution,
    RelationWeightEvent, RelationWeightEventInputs, RelationWeightEvents,
    RelationWeightFactorization, RingCommitment, RingMultiplierOpeningPoint, RingRelationInstance,
