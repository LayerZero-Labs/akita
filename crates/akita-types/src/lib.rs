...
pub use proof::{
    ...
    check_batched_proof_step_shape, checked_total_claims, derive_public_matrix_flat,
    flatten_batched_commitment_rows, folded_root_supports_opening_shape, i8_digits_to_bytes,
    padded_setup_prefix_len, prepare_recursive_opening_point_ext, prepare_root_opening_point,
    prepare_root_opening_point_ext, relation_claim_from_rows, relation_claim_from_rows_extension,
    ring_column_z_first, ring_relation_segment_layout_for_opening_shape,
