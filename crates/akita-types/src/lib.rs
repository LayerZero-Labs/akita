...
pub use proof::{
    ...
    PackedDigits, PointVariableSelection, PreparedOpeningPoint, PublicMatrixSeed,
    RelationOnlyStage2Inputs, RingCommitment, RingMultiplierOpeningPoint, RingRelationInstance,
    RingRelationSegmentLayout, RingSliceSerializer, SegmentTypedWitness, SegmentTypedWitnessShape,
