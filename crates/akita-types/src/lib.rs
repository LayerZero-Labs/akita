...
pub use proof::{
    ...
    append_opening_batch_to_transcript, batched_eval_target_from_opening_batch,
    ...
    terminal_direct_witness_shape, terminal_direct_witness_shape_for_key,
    terminal_e_hat_bytes_from_blocks, terminal_fold_segment_counts,
    ...
    FlatDigitBlocks, FlatRingVec, LevelProofShape, OpeningBatch, OpeningBatchLimits, OpeningPoints,
    PackedDigits, PointVariableSelection, PreparedOpeningPoint, ProverCommitmentRows,
    PublicMatrixSeed, RelationOnlyStage2Inputs, RingCommitment, RingMultiplierOpeningPoint,
    RingRelationInstance, RingRelationSegmentLayout, RingSliceSerializer, SegmentTypedWitness,
    ...
    TerminalWitnessTranscriptParts, GROUPED_ROOT_DENSE_UNSUPPORTED,
