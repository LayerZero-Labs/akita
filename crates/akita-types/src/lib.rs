...
pub use proof::{
    ...
    append_prepared_root_opening_point, checked_total_claims, claim_points_to_base,
    ...
    AkitaStage1StageShape, AkitaStage2Proof, AkitaVerifierSetup, ClaimIncidenceSummary,
    CommitmentVerifier, DegreeOneChallengeSampler, DirectWitnessProof, DirectWitnessShape,
    DummyProof, FlatDigitBlockIter, FlatDigitBlocks, FlatRingVec, LevelProofShape, OpeningPoints,
    PackedDigits, PointClaim, PreparedRootOpeningPoint, PublicMatrixSeed, RingCommitment,
