...
pub use setup::{
    derive_public_matrix_prefix, validate_public_matrix_matches_seed, AkitaExpandedSetup,
    AkitaSetupDescriptor, AkitaSetupSeed, AkitaVerifierSetup, PublicMatrixDerivation,
