...
pub use setup_prefix::{
    ...
    select_setup_prefix_slot, setup_prefix_commit_ring_slots, setup_prefix_level_params,
    setup_prefix_slot_id, MissingSetupPrefixSlotPolicy, SetupPrefixDirectReason,
