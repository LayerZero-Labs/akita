...
fn fold_linf_descriptor_canonical_digest_pinned() {
    ...
    assert_eq!(
        ...
        (
            223,
            [
                0xbb, 0x6e, 0x8f, 0x77, 0x43, 0xb1, 0x4b, 0x15, 0x1a, 0xb6, 0x9d, 0x55, 0xe0, 0xd1,
                0x03, 0xe8, 0x3f, 0xbd, 0x37, 0x38, 0x3b, 0x75, 0xff, 0x9c, 0xd7, 0x3b, 0xb9, 0x6e,
                0x2e, 0xb0, 0x0c, 0xc0,
            ]
        )
    );
...
fn fold_linf_descriptor_canonical_digest_pinned_zk() {
    ...
    assert_eq!(
        ...
        (
            223,
            [
                0x17, 0x61, 0x02, 0x9e, 0x20, 0x26, 0xbd, 0x91, 0x75, 0x43, 0xae, 0x91, 0x8e, 0x61,
                0x34, 0x53, 0xe0, 0xa1, 0x29, 0x17, 0x5f, 0xf4, 0x10, 0xa1, 0x9d, 0xef, 0x52, 0x96,
                0x1e, 0x63, 0x51, 0x9d,
            ]
        ),
        "update pinned zk digest after tail_z planner model id binding"
    );
}
