...
fn fold_linf_descriptor_canonical_digest_pinned() {
    ...
    assert_eq!(
        ...
        (
            182,
            [
                0x63, 0x28, 0x6e, 0xc7, 0xfe, 0xf8, 0xa2, 0xa3, 0x50, 0x30, 0xb3, 0xa9, 0xb4, 0xe3,
                0x89, 0xc7, 0x13, 0x76, 0xbb, 0xa9, 0x8d, 0x12, 0x24, 0x03, 0xb6, 0xc5, 0x0a, 0xd3,
                0x56, 0xe4, 0xe3, 0x3d,
            ]
        )
    );
...
fn fold_linf_descriptor_canonical_digest_pinned_zk() {
    ...
    assert_eq!(
        ...
        (
            182,
            [
                0x66, 0x48, 0x51, 0x81, 0x1f, 0x34, 0x83, 0xaf, 0x14, 0x40, 0xd0, 0x18, 0x76, 0xc6,
                0x14, 0x0a, 0x6c, 0xe9, 0xce, 0x67, 0x09, 0x88, 0xd0, 0x8e, 0x89, 0x00, 0xe4, 0x2c,
                0x65, 0x1d, 0xe2, 0xbe,
            ]
        ),
