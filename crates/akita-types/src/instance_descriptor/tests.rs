...
fn fold_linf_descriptor_canonical_digest_pinned() {
    ...
    assert_eq!(
        ...
        (
            229,
            [
                0x68, 0x39, 0xcb, 0x3c, 0xf6, 0x69, 0x9b, 0x0d, 0xba, 0x5f, 0x36, 0x19, 0xd6, 0x6e,
                0x50, 0x0a, 0xfd, 0x72, 0x73, 0xf1, 0x90, 0x76, 0x6f, 0xbc, 0x41, 0x71, 0x29, 0xa3,
                0x81, 0x21, 0x0f, 0x25,
            ]
        ),
...
fn effective_schedule_digest_binds_root_direct_commit_params() {
    ...
    other_params.live_block_count += 1;
