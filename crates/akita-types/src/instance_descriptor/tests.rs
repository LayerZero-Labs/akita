...
fn fold_linf_descriptor_canonical_digest_pinned() {
    ...
    assert_eq!(
        ...
        (
            174,
            [
                0xfd, 0xb0, 0x5e, 0x1f, 0x26, 0x64, 0x88, 0xc4, 0xc5, 0xdd, 0x18, 0x07, 0xfc, 0x65,
                0x08, 0x66, 0xef, 0xbf, 0x92, 0x22, 0x3b, 0xc8, 0xe4, 0x13, 0xf6, 0x95, 0xb5, 0x74,
                0x3c, 0x97, 0x35, 0x5e,
            ]
        )
    );
...
fn fold_linf_descriptor_canonical_digest_pinned_zk() {
    ...
    assert_eq!(
        ...
        (
            174,
            [
                0xe3, 0x85, 0xab, 0xc4, 0x35, 0x43, 0x43, 0x2f, 0x20, 0xd0, 0x13, 0x7b, 0x53, 0x89,
                0x1e, 0x11, 0xe7, 0x4e, 0xb3, 0x07, 0x1b, 0x70, 0x55, 0x7d, 0x50, 0x25, 0x70, 0x1d,
                0x46, 0x62, 0xaa, 0x85,
            ]
        ),
