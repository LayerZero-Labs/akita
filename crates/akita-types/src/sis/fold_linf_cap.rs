...
/// Retain `2/3` of `t*` (at most one-third reduction vs the tail cap).
pub const FOLD_LINF_SNAP_MIN_TSTAR_RETAIN_NUM: u32 = 2;
pub const FOLD_LINF_SNAP_MIN_TSTAR_RETAIN_DEN: u32 = 3;
