...
pub use norm_bound::{
    ...
    fold_witness_linf_cap_policy, fold_witness_linf_digit_plan, fold_witness_linf_ln_term,
    ...
    ring_product_infinity_norm_bound, rounded_up_collision_linf_t,
    rounded_up_collision_linf_tiered_commitment, rounded_up_collision_linf_w, snap_num_digits_fold_down,
    FoldChallengeNorms, FoldWitnessLinfCapConfig, FoldWitnessLinfCapPolicy,
    FoldWitnessLinfDigitPlan, FoldWitnessNorms,
