...
//!     positions_per_block, decomposition_digits::num_digits_s_commit(decomp, is_root))?;
//! let norm_s = norm_bound::rounded_up_role_a_inf_norm(
//!     bits, family, d, decomp, &stage1, shape, is_root, k, nu, live_block_count, num_claims, width_s as u64)?;
