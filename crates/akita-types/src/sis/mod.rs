...
pub use norm_bound::{
    ...
    fold_witness_l2_pub_norms,
    fold_witness_linf_cap, fold_witness_linf_cap_policy, fold_witness_linf_ln_term,
    fold_witness_linf_tail_bound_sq, isqrt_ceil, l2_sq_from_linf, ring_product_infinity_norm_bound,
