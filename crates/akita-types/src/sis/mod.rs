...
pub use coverage::{
    sis_role_cell, sis_role_cells, sis_role_dimension_supported, SisRoleCell, A_ROLE_RING_DIMS,
    BD_ROLE_RING_DIMS, GADGET_COEFF_LINF_ANCHORS, SIS_MATRIX_ROLES, SIS_MAX_MODULE_RANK,
    SIS_REQUIRED_MAX_WIDTH,
};
