...
//!     num_positions_per_block, decomposition_digits::num_digits_witness(decomp, is_root))?;
...
pub use decomposition_digits::{
    ...
    num_digits_for_bound, num_digits_open, num_digits_setup_prefix_commit, num_digits_witness,
};
