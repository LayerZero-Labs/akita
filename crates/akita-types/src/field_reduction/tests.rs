...
use akita_field::{ExtField, Fp32, RingSubfieldFp4, RingSubfieldFp8, TowerBasisFp4, TwoNr, UnitNr};
...
fn deterministic_subfield_fp4_vector<const D: usize>(tag: u64) -> Vec<RingSubfieldFp4<AkitaF32>> {
    let m = D / 4;
    (0..m)
        .map(|i| {
            let i = i as u64;
