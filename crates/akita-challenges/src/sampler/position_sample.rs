...
pub(crate) fn sample_distinct_positions_into(
    ...
    match universe {
        0..=8 => sample_distinct_positions_into_stack::<8>(cursor, universe, out),
        9..=16 => sample_distinct_positions_into_stack::<16>(cursor, universe, out),
        17..=32 => sample_distinct_positions_into_stack::<32>(cursor, universe, out),
        33..=64 => sample_distinct_positions_into_stack::<64>(cursor, universe, out),
        65..=128 => sample_distinct_positions_into_stack::<128>(cursor, universe, out),
...
mod tests {
    ...
    fn sparse_virtual_permutation_matches_dense_partial_fisher_yates() {
        for (universe, weight) in [(128usize, 7usize), (256, 23), (1024, 16), (2048, 14)] {
            ...
            for round in 0..16 {
                match universe {
                    128 => sample_distinct_positions_into_stack::<128>(
                        &mut dense_cursor,
                        universe,
                        &mut dense,
                    ),
                    256 => sample_distinct_positions_into_stack::<256>(
                        &mut dense_cursor,
                        universe,
                        &mut dense,
                    ),
                    1024 => sample_distinct_positions_into_stack::<1024>(
                        &mut dense_cursor,
                        universe,
                        &mut dense,
                    ),
                    2048 => sample_distinct_positions_into_stack::<2048>(
                        &mut dense_cursor,
                        universe,
                        &mut dense,
                    ),
