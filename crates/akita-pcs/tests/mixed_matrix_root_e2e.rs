//! Mixed commitment-matrix ring-dimension E2E acceptance test.
//!
//! The root fold uses mixed commitment-matrix ring dimensions
...
//!
//! This is the correctness oracle for the verifier's mixed-matrix relation
...
type Cfg = MixedMatrixRootConfig<Envelope, 32, 64>;
...
const LABEL: &[u8] = b"test/mixed_matrix_root_e2e";
...
#[test]
fn mixed_matrix_root_proves_verifies_and_rejects_tamper() {
    init_rayon_pool();
    run_on_large_stack(|| {
