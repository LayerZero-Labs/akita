//! Correctness matrix for the Akita PCS prove→verify roundtrip.
//!
//! All tests assert that an honest prover/verifier cycle succeeds for a specific
...
// ============================================================================
// GROUP E — Heterogeneous configurations
//
// Tests that span multiple commitment groups with different polynomial types or
// field configurations.  These are orthogonal to the Group A/B matrices.
// ============================================================================
