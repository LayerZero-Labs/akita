...
#[path = "integration_tests/akita_fp128_e2e.rs"]
mod akita_fp128_e2e;
#[cfg(feature = "schedules-default")]
#[path = "integration_tests/akita_small_field_e2e.rs"]
mod akita_small_field_e2e;
...
mod label_schedule;
#[cfg(feature = "schedules-default")]
#[path = "integration_tests/matrix_drivers/mod.rs"]
mod matrix_drivers;
#[path = "integration_tests/primality.rs"]
mod primality;
#[path = "integration_tests/protocol_soundness.rs"]
mod protocol_soundness;
#[cfg(feature = "profile-ci")]
...
mod setup;
#[cfg(feature = "schedules-default")]
#[path = "integration_tests/small_field_drivers/mod.rs"]
