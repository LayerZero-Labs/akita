...
use akita_field::{Fp128Packing, Fp16Packing, Fp32Packing, Fp64Packing, Prime128Offset275};

pub(crate) type Mersenne31 = Fp32<{ (1u32 << 31) - 1 }>;
pub(crate) type PackedMersenne31 = Fp32Packing<{ (1u32 << 31) - 1 }>;
pub(crate) type P16O99 = Fp16Packing<{ PRIME16_OFFSET99_MODULUS }>;
...
pub(crate) const PRIME16_OFFSET99: &str = "prime16_offset99";
