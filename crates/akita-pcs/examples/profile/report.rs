...
pub(crate) fn emit_runtime_schedule_summary(
        ...
        .enumerate()
    {
        ...
        tracing::info!(
            ...
            live_ring_elements_per_claim = lp.live_ring_elements_per_claim,
...
pub(crate) fn print_layout(layout: &LevelParams, num_claims: usize, field_bits: u32) {
    tracing::debug!(
        ...
        live_ring_elements_per_claim = layout.live_ring_elements_per_claim,
        live_block_count = layout.live_block_count,
