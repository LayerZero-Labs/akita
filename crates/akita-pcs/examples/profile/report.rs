...
fn segment_typed_z_fold_stats<FF: Field>(
...
trait TerminalProofView<FF: Field, E: Field>: AkitaSerialize {
...
impl<FF: Field + CanonicalEncoding + AkitaSerialize, E: Field + AkitaSerialize>
