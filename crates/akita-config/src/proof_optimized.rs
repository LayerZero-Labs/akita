...
pub(crate) fn setup_matrix_envelope_for_shape<Cfg: CommitmentConfig>(
...
pub mod fp128 {
    use super::*;
    use crate::fast_verifier::impl_fp128_fast_verify_preset;
    ...
    /// Fast-verify onehot `D=32` preset.
    ///
