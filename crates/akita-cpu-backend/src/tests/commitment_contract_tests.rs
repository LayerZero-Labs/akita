...
fn run_custom_commit_source_contract() {
    ...
    let contract_output = crate::commitment::commit::<Cfg, ContractRootPoly, _>(
    ...
    let dense_output = crate::commitment::commit::<Cfg, DensePoly<F>, _>(
    ...
    let no_state_output = crate::commitment::commit::<Cfg, ContractRootPoly, _>(
        std::slice::from_ref(&contract),
        expanded,
        &schedules,
        &no_state_executor,
    ...
    let resident_output = crate::commitment::commit::<Cfg, ContractRootPoly, _>(
        std::slice::from_ref(&contract),
        expanded,
        &schedules,
        &resident_executor,
    ...
    assert!(portable_outer == resident_outer);
    assert_eq!(
        resident_output
            .prover_state
            .portable_hint()
    ...
    let error = crate::commitment::commit::<Cfg, ContractRootPoly, _>(
        std::slice::from_ref(&contract),
        expanded,
        &schedules,
        &portable_executor,
