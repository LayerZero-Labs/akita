...
pub(crate) fn mat_vec_mul_ntt_single_i8<F: Field + CanonicalEncoding, const D: usize>(
...
pub(crate) fn mat_vec_mul_ntt_single_i8_cyclic<F: Field + CanonicalEncoding, const D: usize>(
    slot: &PreparedNttCache<D>,
    num_rows: usize,
    num_cols: usize,
    vec: &[[i8; D]],
