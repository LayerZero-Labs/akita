...
use crate::arithmetic::requirements::RoutedNttRequirement;
...
impl<F: Field + CanonicalEncoding> CpuPreparedSetup<F> {
    ...
    #[cfg(test)]
    pub(crate) fn shared_ntt_cache_bytes(&self) -> usize {
        self.shared_ntt
            .lock()
    ...
    pub(crate) fn drop_built_ntt_slots(&self) -> Result<usize, AkitaError> {
    ...
    pub(crate) fn shared_ntt_cache_metrics(
        &self,
    ...
    pub(crate) fn compression_ntt_cache_bytes(&self) -> usize {
        self.compression_ntt.cache_bytes()
    }

    /// Complete in-memory byte footprint of all CPU NTT caches.
    #[cfg(test)]
    pub(crate) fn ntt_cache_bytes(&self) -> Result<usize, AkitaError> {
    ...
    pub(crate) fn shared_ntt_profile(
        &self,
        ring_d: usize,
    ...
    F: Field + CanonicalEncoding,
{
    ...
    fn prepare_expanded(
        ...
        Ok(CpuPreparedSetup::new(expanded))
    }
