...
pub(crate) enum NttOperationCluster {
...
pub(crate) struct NttExecutionRequirements {
...
impl NttExecutionRequirements {
    ...
    pub(crate) fn entries(&self) -> &[RoutedNttRequirement] {
        &self.entries
    }

    /// Add the A/B work needed to materialize one setup-prefix commitment slot.
    pub(crate) fn add_setup_prefix_commitment(
        &mut self,
        fold_level: usize,
    ...
    pub(crate) fn add_commitment_matrix(
        &mut self,
        fold_level: usize,
