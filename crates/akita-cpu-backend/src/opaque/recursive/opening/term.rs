...
pub struct ExtensionOpeningReductionTerm<E: Field> {
    pub(in crate::opaque::recursive::opening) witness: Vec<E>,
    pub(in crate::opaque::recursive::opening) coeff: E,
    /// Coefficient-scaled next-round values produced by the fused witness fold.
    pub(in crate::opaque::recursive::opening) cached_accumulate: Option<(E, E)>,
}
