...
pub(in crate::opaque::recursive::opening) fn fused_fold_group_head_and_accumulate<
    E: Unreduced + Fold,
>(
...
pub(in crate::opaque::recursive::opening) fn fused_fold_witness_and_accumulate<
    E: Unreduced + Fold,
>(
    witness_evals: &mut Vec<E>,
    folded_factor: &[E],
