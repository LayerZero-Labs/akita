...
//!
//! Q32: `logq = 32` with four `i16` NTT-friendly primes (D ≤ 64).
...
pub const Q32_NUM_PRIMES: usize = 4;
...
/// Number of CRT primes for the `logq = 64` parameter set.
...
/// Raw 30-bit primes for Q64.
pub const Q64_RAW_PRIMES: [i32; Q64_NUM_PRIMES] = [
    D1024_RAW_PRIMES[0],
    D1024_RAW_PRIMES[1],
    D1024_RAW_PRIMES[2],
];
...
/// CRT primes and per-prime Montgomery constants for `logq = 64`.
pub fn q64_primes() -> [NttPrime<i32>; Q64_NUM_PRIMES] {
    std::array::from_fn(|k| NttPrime::compute(Q64_RAW_PRIMES[k]))
}

/// Garner CRT reconstruction constants for Q64.
